...
usingi Flood-Fill. However, we had to merge components into same symbol. For example,
...
%Our nerual network model uses modified LeNet, implemented by Caffe. [Citation needed]
% TODO
...
Michael Nielsen\cite{MichaelNielsen} wrote an introduction on neural networks.
