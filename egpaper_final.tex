...
\begin{abstract}
    ...
    CROHME is a data set of handwritten digits and other symbols that we need. It has 38248 images. % success(?) ratio?
    ...
    In order to determine which expression flow makes sence,
    ...
    We calculated all states in $O(n^2 \sigma^2)$ time using dynamic programming.
    To take the maximum probability of states, we can avoid nonsence expressions, such as $1(+30$.
...
% TODO: web demo screen shot 좀 찍어서 넣어주세요.
