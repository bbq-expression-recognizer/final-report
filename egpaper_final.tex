...
\begin{center}
   \subcaptionbox{First convolution layer (30 channel)}{
        \includegraphics[width=0.75\linewidth]{img/conv1_tile.png}
   }
   \subcaptionbox{Second convolution layer (60 channel)}{
        \includegraphics[width=0.75\linewidth]{img/conv2_tile.png}
   }
   \subcaptionbox{Third convolution layer (90 channel)}{
        \includegraphics[width=0.75\linewidth]{img/conv3_tile.png}
   }
\end{center}
\caption{Trained multichannel masks of each convolution layer.
Latter step contains higher level features.}
\label{fig:conv_tile}
\end{figure}
